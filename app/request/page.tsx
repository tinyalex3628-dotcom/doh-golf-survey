  ...
  if (!loggedIn) {
    return (
      <main className="phone">
        {brandBar}
        <div className="scroll-body" style={{ paddingTop: 60 }}>
          <h1 className="title">
            안녕하세요! 👋
            <br />
            이도형 골프입니다.
      ...
      <div className="scroll-body">
        ...
        {photoPromptVisible && photos.length < 2 && (
          <button
            ...
            style={{ marginBottom: 26, color: "var(--blue)" }}
        ...
        <div className="sheet-overlay" onClick={() => setGuideSheetOpen(false)}>
          <div className="sheet" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="guide-thumbs">
              <div className="guide-thumb" style={{ background: "var(--blue-light)", color: "var(--blue)" }}>
                <span style={{ fontSize: 22 }}>🏌️</span> 정면 예시
              </div>
              <div className="guide-thumb" style={{ background: "#d8e4dc", color: "var(--blue)" }}>
